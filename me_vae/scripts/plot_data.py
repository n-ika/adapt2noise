...
def plot_dec_boundary(all_points,decision,per_enc,enc_num):
    ...
    # plt.xticks(ticks=np.arange(-10,10.1,0.1),labels=[5*x for x in range(1,8)],fontsize=20)
    # plt.yticks(ticks=np.arange(-10,10.1,0.1),labels=[20*x+200 for x in range(0,7)],fontsize=20)
...
def plot_recon(enc_num,stims_train,test_03,test_30,test_33,test_36,test_63,preds_03,preds_30,preds_33,preds_36,preds_63):
    ...
    # plt.xticks(ticks=np.arange(-10,10.1,0.1),labels=[5*x for x in range(1,8)])
    # plt.yticks(ticks=np.arange(-10,10.1,0.1),labels=[20*x+200 for x in range(0,7)])
